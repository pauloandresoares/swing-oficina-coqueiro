...
public class OrdemDeServico extends JInternalFrame {
	...
	private DatePanel datePanelInicio = null;
	private DatePanel datePanelFinal = null;
	...
	public void mostrarValores(DadosOrdemDeServico os){
			...
			getJTextFieldCustoTotal().setText(""+os.getCustoTotal());
		    ...
		    getJTextFieldValorTotal().setText(""+os.getValorTotal());
	...
	private DateField getDateField() {
		if (dateField == null) {
			...
			dateField.addPropertyChangeListener("value",
	...
	private JScrollPane getJScrollPane2() {
		if (jScrollPane2 == null) {
			...
			jScrollPane2.setBounds(new Rectangle(18, 25, 644, 184));
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jLabelFechamento2.setBounds(new Rectangle(266, 17, 66, 21));
			jLabelFechamento2.setText("Data final :");
			jLabel2Data1 = new JLabel();
			jLabel2Data1.setBounds(new Rectangle(9, 16, 72, 21));
			...
			jPanel2.setLayout(null);
			jPanel2.setBounds(new Rectangle(19, 219, 651, 196));
			jPanel2.setBackground(Color.white);
			
			jPanel2.add(jLabel2Data1, null);
			jPanel2.add(jLabelFechamento2, null);
			jPanel2.add(getJButton9(), null);
			jPanel2.add(getDatePanelInicio(), null);
			jPanel2.add(getDatePanelFinal(), null);
		}
		return jPanel2;
	}
	...
	private JButton getJButton9() {
		if (jButton9 == null) {
			...
			jButton9.setBounds(new Rectangle(509, 15, 124, 22));
			...
			jButton9.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					java.util.Date data1 = (java.util.Date) getDatePanelInicio().getValue();
					java.util.Date data2 = (java.util.Date) getDatePanelFinal().getValue();
					String formatada = formatoBanco.format(data1);
					String formatada2 = formatoBanco.format(data2);
					
					
					
					map.put("abertura", formatada );
	...
	private JPanel getJPanel3() {
		if (jPanel3 == null) {
			...
			jPanel3.setBounds(new Rectangle(17, 442, 653, 69));
	...
	private JButton getJButton10() {
		if (jButton10 == null) {
			...
			jButton10.setBounds(new Rectangle(518, 21, 124, 22));
...
/**
 * This method initializes datePanelInicio	
 * 	
 * @return net.sf.nachocalendar.components.DatePanel	
 */
private DatePanel getDatePanelInicio() {
	if (datePanelInicio == null) {
		datePanelInicio = new DatePanel();
		datePanelInicio.setBounds(new Rectangle(7, 44, 244, 141));
		
	}
	return datePanelInicio;
}


/**
 * This method initializes datePanelFinal	
 * 	
 * @return net.sf.nachocalendar.components.DatePanel	
 */
private DatePanel getDatePanelFinal() {
	if (datePanelFinal == null) {
		datePanelFinal = new DatePanel();
		datePanelFinal.setBounds(new Rectangle(265, 44, 244, 141));
	}
	return datePanelFinal;
}
