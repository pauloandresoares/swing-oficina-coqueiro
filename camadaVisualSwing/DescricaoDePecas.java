...
public class DescricaoDePecas extends JInternalFrame {
	...
	private JButton getJButton1Incluir() {
		if (jButton1Incluir == null) {
			...
			jButton1Incluir.addActionListener(new java.awt.event.ActionListener() {
				...
				String marca = getJTextFieldMarca().getText();
				String modelo = getJTextFieldModelo().getText();
				String minima = getJTextFieldMinima().getText();
				String maxima = getJTextFieldMaxima().getText();
				if((nome.equals(""))||(marca.equals(""))||(modelo.equals(""))||(minima.equals(""))||(maxima.equals(""))){
	...
	public void limpar(){
		 ...
		 getJTextFieldMinima().setText("");
		 getJTextFieldMaxima().setText("");
	...
	private JScrollPane getJScrollPane1() {
		if (jScrollPane1 == null) {
			...
			jScrollPane1.setBounds(new Rectangle(81, 71, 501, 109));
		}
		return jScrollPane1;
	}
